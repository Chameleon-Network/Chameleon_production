...
class CoinConfigModel {
  ...
  constructor(data: any = {}, masterAddress?: string) {
    if (!data) {
      return {};
    }
...
export class UserCoinPoolModel {
  ...
  displayBalance?;
  displayFullBalance?;
  displayPendingBalance?;
  displayUnstakeBalance?;
  displayWithdrawReward?;

  constructor(data: any = {}, coins: any[]) {
    if (!data) {
      return {};
    }
...
export class PoolHistory {
  ...
  constructor(data: any = {}, account: any, coins: any[]) {
    if (!data) {
      return {};
    }
    this.id = data.ID;
