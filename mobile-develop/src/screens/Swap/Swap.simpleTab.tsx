...
import { feetokenDataSelector, getExchangeDataEstimateTradeSelector, selltokenSelector, swapInfoSelector } from '@src/store/pdexV3/swap/selectors';
import { Hook } from '@src/components/PdexV3/Extra';
import { KEYS_PLATFORMS_SUPPORTED } from '@src/store/pdexV3/swap/constants';
import { mapperIcon } from '@src/components/SelectOption/SelectOption.modalSelectItem';
...
export const useTabFactories = () => {
  ...
  const selltoken: SelectedPrivacy | undefined = useSelector(selltokenSelector);
