...
import styled from '../../../screens/Liquidity/Liquidity.styled';

export const TYPES = {
  ACTION_SET_CONTRIBUTE_ID: '[pDexV3][liquidity] Set contribute id',
  ACTION_FETCHING_CONTRIBUTE_DATA:
    '[pDexV3][liquidity] Fetching contribute data',
  ACTION_SET_CONTRIBUTE_POOL_DATA:
    '[pDexV3][liquidity] Set contribute pool data',
  ...
  ACTION_SET_FETCHING_CREATE_POOL:
    '[pDexV3][liquidity] Set fetching create pool',
...
export const LIQUIDITY_MESSAGES = {
  ...
  estRate: (_onPress: any) => (
    <Text style={styled.warning}>
      Are you sure? This varies significantly from normal market rates nbsp
      <Text style={{textDecorationLine: 'underline'}} onPress={_onPress}>
