...
const srcChevronRight = require('../../assets/images/icons/icon_chevron_right.png');
...
const ArrowRightGreyIcon = (props) => {
  ...
  return <Image source={srcChevronRight} style={[styled.icon, style]} {...rest} />;
};
