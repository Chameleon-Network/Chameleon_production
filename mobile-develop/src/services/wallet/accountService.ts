...
import {loadListAccountWithBLSPubKey, saveWallet} from './walletShared';
import {storage} from '../storage';
import {getPDexV3Instance} from '@src/store/pdexV3/functions';
...
export default class AccountService {
  ...
  static NO_OF_INPUT_PER_DEFRAGMENT =
    AccountService.NO_OF_INPUT_PER_DEFRAGMENT_TX *
  ...
  static async createAccount(accountName, wallet, initShardID?: number) {
    try {
  ...
  static async defragmentNativeCoin(
    ...
    //TODO: Lib don't have resetProgressTx
