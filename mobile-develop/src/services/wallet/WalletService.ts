...
import {saveWallet, loadListAccountWithBLSPubKey} from './walletShared';
 ...
 */
export {loadListAccountWithBLSPubKey} from './walletShared';
...
export {saveWallet} from './walletShared';
...
export async function loadHistoryByAccount(wallet: any, accountName) {
  wallet.Storage = storage;
...
export async function updateHistoryStatus(wallet: any, txId) {
  //TODO: remove
