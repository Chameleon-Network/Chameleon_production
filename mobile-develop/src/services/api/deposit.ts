...
export const genAvaxDepositAddress = ({
  paymentAddress,
  walletAddress,
  tokenId,
  currencyType,
  ...
  return http.post('avax/generate', body).then(formatResponse);
};

export const genAuroraDepositAddress = ({
  paymentAddress,
  walletAddress,
  tokenId,
  currencyType,
  ...
  return http.post('aurora/generate', body).then(formatResponse);
};
